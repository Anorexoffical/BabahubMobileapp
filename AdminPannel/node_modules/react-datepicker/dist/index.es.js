...
<<<<<<< HEAD
        var customWeekClassName = this.props.weekClassName
            ...
            : undefined;
        return (React.createElement("div", { className: clsx(weekNumberClasses, customWeekClassName) }, this.renderDays()));
=======
...
<<<<<<< HEAD
                dayNames.push(React.createElement("div", { key: "W", className: "react-datepicker__day-name", role: "columnheader" },
                    React.createElement("span", { className: "sr-only" }, "Week number"),
...
<<<<<<< HEAD
                return (React.createElement("div", { key: offset, role: "columnheader", className: clsx("react-datepicker__day-name", weekDayClassName) },
                    React.createElement("span", { className: "sr-only" }, formatDate(day, "EEEE", _this.props.locale)),
...
<<<<<<< HEAD
                React.createElement("div", { className: "react-datepicker__day-names", role: "row" }, _this.header(monthDate))));
=======
