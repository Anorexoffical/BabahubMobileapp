    ...
    <div className="dashboard-main">
      {location.pathname === '/dashboard' ? (
        <div className="dashboard-container">
          <div className="beautiful-dashboard-header">
              ...
              <div className="row g-4 mt-2 justify-content-center">
                <div className="col-12 col-sm-6 col-lg-3">
                  <div className="stat-card stat-card-glass">
                    <div className="stat-icon stat-icon-sales"><FiDollarSign size={32} /></div>
                    <div>
                ...
                <div className="col-12 col-sm-6 col-lg-3">
                  <div className="stat-card stat-card-glass">
                    <div className="stat-icon stat-icon-orders"><FiShoppingBag size={32} /></div>
                    <div>
                ...
                <div className="col-12 col-sm-6 col-lg-3">
                  <div className="stat-card stat-card-glass">
                    <div className="stat-icon stat-icon-customers"><FiUsers size={32} /></div>
                    <div>
                ...
                <div className="col-12 col-sm-6 col-lg-3">
                  <div className="stat-card stat-card-glass">
                    <div className="stat-icon stat-icon-product"><FiPackage size={32} /></div>
                    <div>
